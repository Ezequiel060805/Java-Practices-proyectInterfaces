...
public class Main {
    ...
    */
    ...
    while(cont <= 8){ 
        System.out.println("Favor de introducir la calificacion");
        ...
        promedio = promedio + calificacion ;  
            ...
            System.out.println("La calificacion debe estar entre 0 y 100, intentalo de nuevo. ");
        }
    } 
    promedio = promedio / 8;
    System.out.println("El promedio del alumno es " + promedio);
    System.out.println("El alumno reprobo " + reprobadas);
}
}
